// TODO: Fetch data from the PostgreSQL database (to be implimented later)
function fetchGradeData() {
    ...
    // When the requeest changes status, we run this anonymous function
...
function populateGradebook(data) {
    ...
    let tableElm = document.getElementById("gradebook"); //Get the gradebook table element
        data.forEach(function(assignments){ // For each row of data we're passed in
            ...
            let coluns = []; // Handy place to stick the columns of information
            ...
            columns.name.appendChild(
                ...
                document.createTextNode(assignments.last_name + ", " + assignment.first_name)
            );
